describe PrioriData::Controllers::Publishers do
  ...
  describe '#index' do
    context 'when parameters are valid' do
      ...
      it 'searches for the desired publisher' do
    ...
    context 'when monetization is invalid' do
      ...
      it 'does not search for the publisher' do
  ...
  describe '#response' do
    ...
    context 'when there are resources' do
      ...
      before do
        ...
        allow(PrioriData::VOs::Publisher).to receive(:hash).and_return(resources)
      end
